...
flowchart TB
    subgraph Cron任务
        F[Markdown文件<br/>人类可读]
        D[SQLite状态<br/>机器高效]
    end

    subgraph 记忆
        F2[Markdown文件<br/>人类可编辑]
        D2[SQLite索引<br/>快速查询]
    end
...
flowchart LR
    ...
    style BeforeRequest fill:#FFE0B2
    style AfterResponse fill:#E3F2FD
```
