...
// Re-exports
pub use config::{
    AgentConfig, DEFAULT_MAX_ITERATIONS, DEFAULT_MAX_TOKENS, DEFAULT_MAX_TOOL_RESULT_CHARS,
    DEFAULT_MEMORY_WINDOW, DEFAULT_MODEL, DEFAULT_SESSION_IDLE_TIMEOUT_SECS,
    DEFAULT_SUBAGENT_TIMEOUT_SECS, DEFAULT_TEMPERATURE, DEFAULT_WAIT_TIMEOUT_SECS,
};
pub use context::{AgentContext, PersistentContext};
pub use loop_::{AgentLoop, AgentResponse};

// ── Skill loading (inlined from skill_loader.rs) ──
